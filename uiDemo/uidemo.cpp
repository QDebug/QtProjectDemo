...
UiDemo::UiDemo(QWidget *parent) : QDialog(parent), ui(new Ui::UiDemo)
{
    ui->setupUi(this);
    this->initForm();
    this->initStyle();
...
void UiDemo::initForm()
{
    ...
    IconHelper::Instance()->setIcon(ui->labIcon, QChar(0xf0f4), 20);
    IconHelper::Instance()->setIcon(ui->btnMin, QChar(0xf068), 12);
    IconHelper::Instance()->setIcon(ui->btnMax, QChar(0xf067), 12);
    IconHelper::Instance()->setIcon(ui->btnClose, QChar(0xf00d), 12);
...
void UiDemo::on_btnMin_clicked()
{
    showMinimized();
}

void UiDemo::on_btnMax_clicked()
{
...
void UiDemo::on_btnClose_clicked()
{
    close();
}
